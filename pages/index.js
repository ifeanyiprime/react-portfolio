      ...
      <main className="bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900">
        ...
        <section>
          ...
          <div className="lg:flex lg:gap-10">
            <Card
              src={design}
              head="Beautiful Designs"
              body="Create elegant designs suited for your needs following core design theory."
              sub="Design tools I use"
              subBody={["Photoshop", "Illustrator", "Figma"]}
            />
            <Card
              src={code}
              head="Beautiful Designs"
